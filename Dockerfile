...
RUN curl -L --max-redirs 5 --retry 5 --no-progress-meter --output "SaxonHE11-6J.zip" "https://raw.githubusercontent.com/${SAXON_HE_REPOSITORY}/download/SaxonHE11-6/SaxonHE11-6J.zip" && \
